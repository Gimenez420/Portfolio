export default function Hero() {
    return (
        <section className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 px-6 py-20 md:grid-cols-2">
            <div>
            <p className="mb-4 text-sm font-semibold tracking-widest text-purple-400">
                DESARROLLADOR WEB
            </p>
            ...
            <h1 className="text-5xl font-bold leading-tight md:text-6xl">
                Ricardo
                <br />
                <span className="text-purple-500">Giménez Valero</span>
            </h1>

            <p className="mt-6 max-w-xl text-lg leading-relaxed text-gray-400">
                Desarrollador web junior interesado en crear aplicaciones
                modernas, funcionales y seguir aprendiendo nuevas tecnologías.
            </p>
